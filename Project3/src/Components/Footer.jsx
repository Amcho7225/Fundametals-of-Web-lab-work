  ...
  return (
    ...
    >
      <StackColumn>
        ...
        <FooterLink text={"St Grad, Sarajevo 71000, bos"} />
        <FooterLink text={"25 999-345-10800"} />
        <FooterLink text={"info@recipesales.com"} />
      </StackColumn>

      <StackColumn>
        <FooterTitle text={"our services"} />
        <FooterLink text={"buy recipe"} />
        <FooterLink text={"sell recipe"} />
      </StackColumn>
      <StackColumn>
